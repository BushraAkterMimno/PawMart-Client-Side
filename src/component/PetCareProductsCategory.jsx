  ...
  useEffect(() => {
    fetch("/PetCareProducts.json") 
      ...
      .then((data) => {
        ...
        setRandomFood(shuffled.slice(0, 6));
      });
  }, []);

  const handleSeeDetails = (id) => {
    navigate(`/care-product-details/${id}`); // route change
  };

  return (
    <div className="py-10">
      <h2 className="text-3xl font-bold text-center mb-8">Pet Care Products</h2>
...
export default PetCareProductsCategory;