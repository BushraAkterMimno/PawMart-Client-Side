    ...
    <div className="max-w-6xl mx-auto px-4 py-10 relative">
      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p><b>Brand:</b> {food.brand || "N/A"}</p>
          <p className="text-xl mt-2"><b>Price:</b> ${food.price}</p>
      ...
      <div className="mt-12 bg-gray-100 p-6 rounded-xl">
        ...
        <p>
          {food.moreInfo ||
            "This food product provides complete nutrition and supports your pet’s overall health."}
        </p>
      </div>
